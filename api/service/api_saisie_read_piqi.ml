...
and Identifier_person:
  sig
    type t = {
      ...
      mutable nb_asc_max: Api_saisie_read_piqi.protobuf_int32;
      mutable nb_desc_max: Api_saisie_read_piqi.protobuf_int32;
    }
...
and parse_identifier_person x =
  ...
  let _nb_asc_max, x = Piqirun.parse_required_field 6 parse_protobuf_int32 x in
  let _nb_desc_max, x = Piqirun.parse_required_field 7 parse_protobuf_int32 x in
  Piqirun.check_unparsed_fields x;
  {
...
and gen__identifier_person code x =
  ...
  let _nb_asc_max = Piqirun.gen_required_field 6 gen__protobuf_int32 x.Identifier_person.nb_asc_max in
  let _nb_desc_max = Piqirun.gen_required_field 7 gen__protobuf_int32 x.Identifier_person.nb_desc_max in
...
and default_identifier_person () =
  {
    ...
    Identifier_person.nb_asc_max = default_protobuf_int32 ();
    Identifier_person.nb_desc_max = default_protobuf_int32 ();
  }
and default_error () =
  {
